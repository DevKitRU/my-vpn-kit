...
**Как оплатить из РФ:** я покупал OVH (а так же подписку Claude Pro) через бот **[@platipomiru_sup_bot](https://t.me/platipomiru_sup_bot)** в Telegram. Они выпускают виртуальную карту Visa/Mastercard под конкретный платёж, оплачиваешь зарубежный сервис обычным способом. Пользуюсь сам, проблем не было. Альтернативы (Easy Pay, Getsby, ВКоины и т.д.) — не тестировал.
...
- **Чистая Windows 11 / VM** — не проверено. Windows Sandbox конфликтует с Kaspersky, а чистой машины без Касперского у автора под рукой не было. Первым пользователям — будьте готовы к мелким сюрпризам, [открывайте issue](https://github.com/DevKitRU/my-vpn-kit/issues).

Сообщайте о проблемах, PR приветствуются. Особенно — добавление новых РФ-платформ в direct-списки (банки / маркетплейсы / игры).
